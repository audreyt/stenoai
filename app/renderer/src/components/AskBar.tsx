...
function AskBarComposer({
  ...
  // Recording started: close the saved-meeting transcript panel (it would
  // overlap the LiveTranscriptBar). Live recording keeps the composer active,
  // so we only close transcript on non-recording disabled states.
  React.useEffect(() => {
