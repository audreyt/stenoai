...
The maintained Ornith profile uses roughly 6.1GB for `ornith-1.5:9b`. The upstream local-Gemma setup uses about 7GB with its optional Parakeet fallback. Ollama stores model files under `~/.ollama/models/`.
</Accordion>
