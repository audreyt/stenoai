...
<Steps>
  <Step title="Download the DMG">
    Download the Apple Silicon DMG from [github.com/audreyt/stenoai/releases](https://github.com/audreyt/stenoai/releases). Until the first fork release is published, use the local build instructions in the repository README.
  </Step>
